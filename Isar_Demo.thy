...
subsection "Streamlining proofs"
...
lemma shows "\<exists> x y :: int. x < z & z < y" (is "\<exists> x y. ?P x y")
proof -
...
subsection "Solutions to interactive exercises"

lemma assumes "\<exists>x. \<forall>y. P x y" "B c" shows "\<forall>y. \<exists>x. P x y"
proof
  fix b
