...
text \<open>To display types inside terms:\<close>
declare [[show_types]]
term "Suc x = Succ y"
...
text \<open>Numbers and + are overloaded:\<close>
...
text\<open>Terms must be type correct! Try this: \texttt{term "True + False"}\<close>
...
subsection \<open>Basic proofs\<close>
...
text \<open>You can give it a name\<close>
